    ...
    <div className="min-h-screen bg-background text-foreground overflow-y-auto">
      ...
      <section className="relative min-h-[60vh] flex flex-col items-center justify-center px-6 py-12 text-center">
        ...
        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mb-6">
          Explore how the <span className="text-primary font-medium">same forelimb bones</span> appear across very different animals.
        </p>
        
        <p className="text-base text-muted-foreground/80 max-w-xl mb-8">
          By overlaying scientific 3D models onto your <strong className="text-foreground">right hand</strong> using the camera, you can see how evolution reshapes the same structures for swimming, walking, flying, and grasping.
        </p>
        
        <p className="text-xl font-semibold text-primary">
          Different animals. Same bones.
        </p>
      </section>
      ...
      <section className="px-6 py-12 bg-secondary/30">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-muted-foreground mb-4">
            The colored bones you see are <strong className="text-foreground">homologous structures</strong> — bones shared by many vertebrates and inherited from a common ancestor.
          </p>
          
          <p className="text-muted-foreground">
            They haven't been replaced over time.<br />
